      ...
      {analysisResult && (
        <Tabs defaultValue="summary" className="w-full animate-in fade-in-50 duration-500">
          <TabsList className="grid w-full grid-cols-3">
            <TabsTrigger value="summary"><Sparkles className="mr-2 h-4 w-4" />Summary</TabsTrigger>
            <TabsTrigger value="keyConcepts"><ListChecks className="mr-2 h-4 w-4" />Key Concepts</TabsTrigger>
          ...
          <TabsContent value="quiz">
            <Card className="shadow-md">
              <CardHeader>
                ...
                <CardDescription>Test your understanding with these MCQs.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                {Object.entries(mcqAnswers).map(([qIndexStr, mcqItem]) => {
                  ...
                  return (
                    <div key={`mcq-${questionIndex}`} className="p-4 border rounded-lg bg-card/30">
                      <p className="font-semibold mb-3">Question {questionIndex + 1}: {mcqItem.question}</p>
                      <RadioGroup
                      ...
                      {mcqItem.answerRevealed && (
                        <div className={cn(
                            ...
                            isCorrect ? "bg-green-100 dark:bg-green-900/50 border border-green-300 dark:border-green-700 text-green-800 dark:text-green-200" 
                                      : "bg-red-100 dark:bg-red-900/50 border border-red-300 dark:border-red-700 text-red-800 dark:text-red-200"
                          )}
                        >
