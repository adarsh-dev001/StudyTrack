  ...
  return (
    <section className="w-full py-12 md:py-24 lg:py-32 xl:py-40 bg-gradient-to-b from-background to-secondary/30">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid gap-6 lg:grid-cols-1 lg:items-center xl:grid-cols-[1fr_550px] xl:gap-12">
          ...
          <div className="relative mx-auto aspect-video w-full max-w-2xl overflow-hidden rounded-xl lg:aspect-[4/3] xl:aspect-video mt-8 lg:mt-0">
            <Image
